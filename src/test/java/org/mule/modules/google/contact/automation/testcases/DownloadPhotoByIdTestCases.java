...
public class DownloadPhotoByIdTestCases extends GoogleContactsTestParent {

    @Before
    public void setUp() throws Exception {
        initializeTestRunMessage("downloadPhotoById");
    ...
    @Test
    public void testDownloadPhotoById() {
        try {
            // Wait for the remote google object to be refreshed
            Thread.sleep(5000);

            InputStream response = runFlowAndGetPayload("download-photo-by-id");
