...
@SuiteClasses({
        ...
        DeleteGroupTestCases.class, DownloadPhotoByIdTestCases.class,
        DownloadPhotoTestCases.class, GetContactByIdTestCases.class,
        GetContactsTestCases.class, GetGroupByIdTestCases.class,
        GetGroupByNameTestCases.class, GetGroupsTestCases.class,
        InsertContactTestCases.class, UpdateContactPhotoTestCases.class,
