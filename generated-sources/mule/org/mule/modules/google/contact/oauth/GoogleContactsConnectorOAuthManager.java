...
import org.mule.modules.google.contact.adapters.GoogleContactsConnectorHttpCallbackAdapter;
...
public class GoogleContactsConnectorOAuthManager
    ...
    implements MuleContextAware, Initialisable, Capabilities, MetadataAware, OAuthManager<GoogleContactsConnectorOAuth2Adapter> , ProcessAdapter<GoogleContactsConnectorOAuth2Adapter>
{
        ...
        throws InitialisationException
    {
        ...
        accessTokenPoolFactory = new GoogleContactsConnectorOAuthClientFactory(this);
        accessTokenPool = new GenericKeyedObjectPool(accessTokenPoolFactory, config);
        defaultUnauthorizedConnector = new GoogleContactsConnectorOAuth2Adapter();
        ...
        throws Exception
    {
        ...
        GoogleContactsConnectorOAuth2Adapter object = ((GoogleContactsConnectorOAuth2Adapter) accessTokenPool.borrowObject(userId));
        if (logger.isDebugEnabled()) {
            StringBuilder messageStringBuilder = new StringBuilder();
    ...
    @Override
    public<P >ProcessTemplate<P, GoogleContactsConnectorOAuth2Adapter> getProcessTemplate() {
