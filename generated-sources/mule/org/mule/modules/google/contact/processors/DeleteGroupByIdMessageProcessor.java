...
/**
 * DeleteGroupByIdMessageProcessor invokes the {@link org.mule.modules.google.contact.GoogleContactsConnector#deleteGroupById(java.lang.String)} method in {@link GoogleContactsConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-SNAPSHOT", date = "2014-04-16T09:31:06-05:00", comments = "Build master.1915.dd1962d")
public class DeleteGroupByIdMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public DeleteGroupByIdMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedGroupId = ((String) evaluateAndTransform(getMuleContext(), event, DeleteGroupByIdMessageProcessor.class.getDeclaredField("_groupIdType").getGenericType(), null, groupId));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((GoogleContactsConnector) object).deleteGroupById(_transformedGroupId);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleContactsConnector at deleteGroupById retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
