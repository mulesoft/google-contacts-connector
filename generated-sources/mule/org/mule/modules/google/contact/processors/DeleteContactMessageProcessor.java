...
/**
 * DeleteContactMessageProcessor invokes the {@link org.mule.modules.google.contact.GoogleContactsConnector#deleteContact(org.mule.modules.google.contact.wrappers.GoogleContactEntry)} method in {@link GoogleContactsConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected GoogleContactEntry _entryType;
        ...
        throws Exception
    {
        ...
        try {
            ...
            final GoogleContactEntry _transformedEntry = ((GoogleContactEntry) evaluateAndTransform(getMuleContext(), event, DeleteContactMessageProcessor.class.getDeclaredField("_entryType").getGenericType(), null, entry));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((GoogleContactsConnector) object).deleteContact(_transformedEntry);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleContactsConnector at deleteContact retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
