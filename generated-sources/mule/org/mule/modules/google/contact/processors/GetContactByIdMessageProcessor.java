...
/**
 * GetContactByIdMessageProcessor invokes the {@link org.mule.modules.google.contact.GoogleContactsConnector#getContactById(java.lang.String)} method in {@link GoogleContactsConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedId = ((String) evaluateAndTransform(getMuleContext(), event, GetContactByIdMessageProcessor.class.getDeclaredField("_idType").getGenericType(), null, id));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GoogleContactsConnector) object).getContactById(_transformedId);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleContactsConnector at getContactById retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
