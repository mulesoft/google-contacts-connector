...
/**
 * DownloadPhotoMessageProcessor invokes the {@link org.mule.modules.google.contact.GoogleContactsConnector#downloadPhoto(org.mule.modules.google.contact.wrappers.GoogleContactEntry)} method in {@link GoogleContactsConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-SNAPSHOT", date = "2014-04-16T09:31:06-05:00", comments = "Build master.1915.dd1962d")
public class DownloadPhotoMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public DownloadPhotoMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final GoogleContactEntry _transformedContact = ((GoogleContactEntry) evaluateAndTransform(getMuleContext(), event, DownloadPhotoMessageProcessor.class.getDeclaredField("_contactType").getGenericType(), null, contact));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GoogleContactsConnector) object).downloadPhoto(_transformedContact);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleContactsConnector at downloadPhoto retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
