    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public BatchGroupsMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedBatchId = ((String) evaluateAndTransform(getMuleContext(), event, BatchGroupsMessageProcessor.class.getDeclaredField("_batchIdType").getGenericType(), null, batchId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GoogleContactsConnector) object).batchGroups(_transformedBatchId, _transformedOperations);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleContactsConnector at batchGroups retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
